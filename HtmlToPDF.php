...
$GLOBALS['WKPDF_BASE_PATH']= BASE_PATH.'/library/HtmlToPDF/';
...
class HtmlToPDF_HtmlToPDF
{
	...
	public function render(){
        $web=BASE_PATH.'/tmp/'.basename($this->tmp);
	//debug($web); die();
